...
class AdaptiveResponseGenerator:
    ...
    def _determine_response_type(
        ...
        space_count = len(workspace_data.get("spaces", []))
        app_count = sum(
            len(space.get("applications", {}))
    ...
    def _summarize_workspace(self, workspace_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        summary = {
            ...
            "total_apps": sum(len(space.get("applications", {})) for space in spaces),
            "space_details": [],
        }
    ...
    def _analyze_all_applications(
        ...
        for space in workspace_data.get("spaces", []):
            for app_name, windows in space.get("applications", {}).items():
