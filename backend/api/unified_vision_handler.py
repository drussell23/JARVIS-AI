...
from ..vision.claude_ai_core import ClaudeAICore
from ..vision.intelligent_notifications import IntelligentNotificationSystem
from ..autonomy.autonomous_action_executor import AutonomousActionExecutor
from ..autonomy.workspace_analyzer import WorkspaceAnalyzer
from ..vision.pattern_learner import PatternLearner
...
class UnifiedVisionHandler:
    ...
    def __init__(self):
        self.vision_system = VisionSystemV2()
        self.response_composer = DynamicResponseComposer()
        self.natural_responder = NaturalResponseGenerator()
        self.performance_optimizer = PerformanceOptimizer()
        self.claude_ai = ClaudeAICore()
        self.notification_system = IntelligentNotificationSystem()
        self.action_executor = AutonomousActionExecutor()
    ...
    def _setup_routes(self):
        ...
        # Vision operations
        self.router.register('request_workspace_analysis', self.handle_workspace_analysis)
    ...
    def _setup_middleware(self):
        ...
        async def logging_middleware(message: Dict[str, Any], context: VisionContext) -> Dict[str, Any]:
            """Log all incoming messages"""
            logger.debug(f"Received message from {context.client_id}: {message.get('type', 'unknown')}")
            return message
            
        async def validation_middleware(message: Dict[str, Any], context: VisionContext) -> Dict[str, Any]:
        ...
        async def performance_middleware(message: Dict[str, Any], context: VisionContext) -> Dict[str, Any]:
    ...
    async def handle_monitoring_interval(self, message: Dict[str, Any], context: VisionContext) -> Dict[str, Any]:
    ...
    async def handle_autonomous_mode(self, message: Dict[str, Any], context: VisionContext) -> Dict[str, Any]:
    ...
    async def handle_workspace_analysis(self, message: Dict[str, Any], context: VisionContext) -> Dict[str, Any]:
    ...
    async def handle_vision_command(self, message: Dict[str, Any], context: VisionContext) -> Dict[str, Any]:
        ...
        try:
            ...
            enhanced_result = self.response_composer.compose_response(
                command,
                result
            )
    ...
    async def handle_claude_vision(self, message: Dict[str, Any], context: VisionContext) -> Dict[str, Any]:
        ...
        try:
            if not self.claude_ai.is_available():
                return {
                    'type': 'error',
                    'message': 'Claude AI is not available'
                }
    ...
    async def handle_action_execution(self, message: Dict[str, Any], context: VisionContext) -> Dict[str, Any]:
    ...
    async def handle_autonomous_action(self, message: Dict[str, Any], context: VisionContext) -> Dict[str, Any]:
    ...
    async def handle_pattern_learning(self, message: Dict[str, Any], context: VisionContext) -> Dict[str, Any]:
    ...
    async def handle_get_patterns(self, message: Dict[str, Any], context: VisionContext) -> Dict[str, Any]:
    ...
    async def handle_get_status(self, message: Dict[str, Any], context: VisionContext) -> Dict[str, Any]:
        """Get system status"""
        try:
            status = {
    ...
    async def handle_ping(self, message: Dict[str, Any], context: VisionContext) -> Dict[str, Any]:
    ...
    async def handle_unknown_message(self, message: Dict[str, Any], context: VisionContext) -> Dict[str, Any]:
        ...
        while context.monitoring_active:
            try:
                ...
                if analysis.important_notifications:
                    ...
                    await self._send_to_client(context.client_id, {
    ...
    def create_context(self, client_id: str, capabilities: List[str], metadata: Dict[str, Any]) -> VisionContext:
    ...
    async def handle_websocket_message(self, message: Dict[str, Any], **kwargs) -> Optional[Dict[str, Any]]:
...
async def handle_monitoring_interval(message: Dict[str, Any], **kwargs) -> Dict[str, Any]:
    """Handle monitoring interval updates"""
    return await unified_handler.handle_websocket_message(message, **kwargs)


async def handle_workspace_analysis(message: Dict[str, Any], **kwargs) -> Dict[str, Any]:
