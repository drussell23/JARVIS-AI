...
class AsyncSystemManager:
    ...
    def print_header(self):
        """Print system header"""
        print(f"\n{Colors.HEADER}{'='*60}")
        print(f"{Colors.BOLD}🤖 JARVIS AI Agent v3.4.0 - Multi-Window Awareness Edition 🪟{Colors.ENDC}")
        ...
        print(f"{Colors.GREEN}✅ NEW: Multi-Window Workspace Intelligence!{Colors.ENDC}")
        print(f"{Colors.GREEN}✅ NEW: Sees ALL windows, not just the focused one{Colors.ENDC}")
        print(f"{Colors.CYAN}🎤 Smart microphone helper & extended timeouts{Colors.ENDC}")
        print(f"{Colors.BOLD}🪟 BREAKTHROUGH: Full Workspace Awareness with Claude AI!{Colors.ENDC}")
        print(f"{Colors.GREEN}✅ v3.4.0: 'What's on my screen?' - Lists ALL open windows{Colors.ENDC}")
        print(f"{Colors.CYAN}🧠 'What am I working on?' - Prioritizes your focused window{Colors.ENDC}")
        print(f"{Colors.YELLOW}🎯 NEW: Understands window relationships & context{Colors.ENDC}")
        if self.is_m1_mac:
            ...
            try:
                ...
                if screenshot is None:
                    ...
                    if os.getenv("ANTHROPIC_API_KEY"):
                        print(f"{Colors.BOLD}✨ Multi-Window Intelligence Active!{Colors.ENDC}")
                        print(f"{Colors.GREEN}   • Ask 'What's on my screen?' to see ALL windows{Colors.ENDC}")
                        print(f"{Colors.GREEN}   • Ask 'What am I working on?' for focused window context{Colors.ENDC}")
                        print(f"{Colors.GREEN}   • Ask 'Do I have any messages?' to check communication apps{Colors.ENDC}")
            except ImportError:
    ...
    def print_access_info(self):
        ...
        print(f"\n{Colors.BOLD}🪟 Multi-Window Commands (NEW v3.4.0!):{Colors.ENDC}")
        print(f"  • {Colors.GREEN}Workspace Overview: 'What's on my screen?' - Lists ALL open windows{Colors.ENDC}")
        print(f"  • {Colors.GREEN}Focused Work: 'What am I working on?' - Prioritizes current window{Colors.ENDC}")
        print(f"  • {Colors.CYAN}Window Count: 'What windows are open?' - Shows count and apps{Colors.ENDC}")
        print(f"  • {Colors.CYAN}Communication: 'Do I have any messages?' - Checks Discord, Slack, etc.{Colors.ENDC}")
        print(f"  • {Colors.YELLOW}Error Detection: 'Are there any errors?' - Scans all terminals{Colors.ENDC}")
        print(f"  • {Colors.YELLOW}Context Aware: 'Describe my workspace' - Full workspace analysis{Colors.ENDC}")
        print(f"  • Verification: 'Can you see my screen?' - Confirms multi-window vision")
        print(f"  • Intelligence: 'Help me debug this', 'What should I do next?'")
        ...
        print(f"  • 🪟 MULTI-WINDOW AWARENESS: Sees your ENTIRE workspace, not just one window!")
        print(f"  • 🧠 Window relationship detection - understands how windows work together")
        print(f"  • 🎯 Smart query routing - checks relevant windows based on your question")
        print(f"  • 📊 Workspace intelligence - tracks up to 50+ windows simultaneously")
        print(f"  • ✅ v3.4.0: Full workspace comprehension with Claude Vision API")
